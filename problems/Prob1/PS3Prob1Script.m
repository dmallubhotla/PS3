...
Export[FileNameJoin[{ImageDir, "4000Spectrum.jpg"}], 
	Plot[rho[Quantity[l, "Nanometers"], Quantity[4000, "Kelvins"]], {l, 1, 1000},  AxesLabel->{\[Lambda], \[Rho]}], 
	ImageResolution -> 1000
]

Export[FileNameJoin[{ImageDir, "6000Spectrum.jpg"}], 
	Plot[rho[Quantity[l, "Nanometers"], Quantity[6000, "Kelvins"]], {l, 1, 1000},  AxesLabel->{\[Lambda], \[Rho]}],
	ImageResolution -> 1000
]
